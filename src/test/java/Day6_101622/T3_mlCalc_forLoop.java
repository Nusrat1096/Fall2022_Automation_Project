...
public class T3_mlCalc_forLoop {
    public static void main(String[] args) throws InterruptedException {
        ...
        // create sets of array list for purchase price, down payment and interest rate
        ArrayList<String> purchasePrice, downPayment, interestRate;
        //purchase price arraylist
        ...
        for (int i= 0; i< interestRate.size(); i++){
            ...
            System.out.println("For down payment " + downPayment.get(1) + " the Monthly payment is " + mntPayment);
